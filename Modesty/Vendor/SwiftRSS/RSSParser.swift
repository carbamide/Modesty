...
// MARK: NSXMLParserDelegate
    ...
    public func parser(parser: NSXMLParser, didEndElement elementName: String, namespaceURI: String?, qualifiedName qName: String?) {
        ...
        if let item = self.currentItem
        {
            ...
            {
                item.setLinkFromString(self.currentElement)
            }
            ...
            {
                item.setPubDateFromString(self.currentElement)
            }
            ...
            {
                item.setCommentsLinkFromString(self.currentElement)
            }
            ...
            {
                item.setCommentRSSLinkFromString(self.currentElement)
            }
