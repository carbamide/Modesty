...
public class RSSItem: NSObject, NSCoding {
    ...
    public func setLinkFromString(let linkString: String!)
    {
    ...
    public func setPubDateFromString(let dateString: String!)
    {
    ...
    public func setCommentsLinkFromString(let linkString: String!)
    {
    ...
    public func setCommentRSSLinkFromString(let linkString: String!)
    {
